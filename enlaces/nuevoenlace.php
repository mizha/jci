...
<div id="centro">
	...
	function validar()
	{
		...
		{alert("Debes poner el link") ;
       		document.form1.cuerpo.focus() ;
       		return 0;
		}
		if (document.form1.descripcion.value.length>=150 )
		{alert("EL link nes demasiado larga") ;
       		document.form1.cuerpo.focus() ;
       		return 0;
		}
		if (document.form1.imagen.value.length==0 )
		{alert("La direccion de la imagen a ser cargada") ;
       		document.form1.cuerpo.focus() ;
       		return 0;
		}
	...
	<h1>Crear nuevo enlace</h1><br><br>
  ...
  <tr>
	...
	<? echo '<input name="usuario" type="hidden" value="'.$ci.'">' ?>
      <input name="imagen" id="imagen" type="file"/>&nbsp;&nbsp;<h4>Es Completamente necesario que subas una imagen relacionada</h4></td>
  </tr>
  <tr>
    <td rowspan="2"></td>
    <td width="50%"><input type="button" value="Enviar Enlace" style="margin-bottom:10px;" onClick="validar();"></td>
